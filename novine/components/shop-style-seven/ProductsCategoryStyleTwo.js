                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4 col-md-12">
                            <div className="single-category-box">
                                <img src="/images/category-image/category-new-img1.jpg" alt="image" />
                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="row">
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-category-box">
                                        <img src="/images/category-image/category-new-img2.jpg" alt="image" />
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-category-box">
                                        <img src="/images/category-image/category-new-img3.jpg" alt="image" />
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="single-category-box">
                                        <img src="/images/category-image/category-new-img4.jpg" alt="image" />
