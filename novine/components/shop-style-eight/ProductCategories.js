                    ...
                    <div className="row">
                        <div className="col-lg-4 col-sm-6">
                            <div className="category-boxes">
                                <img src="/images/category-product-image/cp-img8.jpg" alt="image" />
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="category-boxes">
                                <img src="/images/category-product-image/cp-img7.jpg" alt="image" />
                        ...
                        <div className="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0">
                            <div className="category-boxes">
                                <img src="/images/category-product-image/cp-img6.jpg" alt="image" />
